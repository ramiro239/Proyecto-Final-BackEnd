...
export default class ProductController {
    get = async(req, res, next) => {
        ...
        try {
            ...
            (products.hasNextPage == true ) ? nextLink = `https://ecommerce-32240-production.up.railway.app/api/products/?limit=${limit}&page=${page+1}&query=${query}` : nextLink = null;
            (products.hasPrevPage == true ) ? prevLink = `https://ecommerce-32240-production.up.railway.app/api/products/?limit=${limit}&page=${page-1}&query=${query}` : prevLink = null;
