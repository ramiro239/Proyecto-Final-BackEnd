...
export default class ViewController {
    get = async(req, res, next) => {
        ...
        try {
            ...
            (products.hasNextPage == true ) ? nextLink = `http://ecommerce-32240-production.up.railway.app/?limit=${limit}&page=${page+1}&query=${query}` : nextLink = null;
            (products.hasPrevPage == true ) ? prevLink = `http://ecommerce-32240-production.up.railway.app/?limit=${limit}&page=${page-1}&query=${query}` : prevLink = null;
